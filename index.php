        ...
        <h1 style="text-align: center;">What out student says</h1>
          ...
          <div class="container mb-2">
            ...
            <footer class="blockquote-footer text-black">
               Surovi Adlin Palma in <abbr title="Computer Science and Engineering batch no 14">CSE-14</abbr>
            </footer>
              </blockquote>
            </div>
            ...
            <div class="col-md-5 bg-info text-black m-2 p-2 border rounded" data-aos="slide-left">
              <blockquote class="blockquote p-3">
                ...
                <footer class="blockquote-footer text-muted">
                        Nafiz Al Rashid Sun in <abbr title="Computer Science and Engineering batch no 14">CSE-14</abbr>
                </footer>
              </blockquote>
            </div>
          </div>
